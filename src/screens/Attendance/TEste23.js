          ...
          >
            <Text
              style={[
                ...
                { color: colors.text }, // Mantém a cor do tema

                active === i && styles.activeBtnText, // Estilo ativo
              ]}
            >
              {btn}
            </Text>

            {/* Adiciona o indicador de 'ativo' diretamente aqui */}

            {active === i && <View style={styles.animatedBtnContainer} />}
          </TouchableOpacity>
        ))}

        {/* O <Animated.View> que existia aqui foi removido */}
      </View>
    );
  }
      ...
      <View style={styles.cardContainer}>
        <View style={styles.infoBlock}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoValue}>{schedule.diagnosis_gestation}</Text>
          </View>
        ...
        <ButtonContainer buttons={buttons} onClick={onClick} active={active} />
